...
set DataType0 [list "axi_interface_type" "struct axi_interface_type" $structMem0 1 0 ]
set Port0 [list $PortName0 $Interface0 $DataType0 $Pointer0 $Dims0 $Const0 $Volatile0 $ArrayOpt0]
lappend PortList $Port0
set PortName1 "start_point"
set BitWidth1 "8"
set ArrayOpt1 ""
set Const1 "0"
set Volatile1 "0"
...
set DataType2 [list "axi_interface_type" "struct axi_interface_type" $structMem2 1 0 ]
